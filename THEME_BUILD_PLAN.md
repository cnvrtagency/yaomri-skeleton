...
- Theme Editor settings QA pass is complete for key pain points: Header group ordering/shadow placement, mobile nav size, country selector text routing, shared Section headings ownership, Featured Collection alignment ownership, and Product cards global typography controls.
